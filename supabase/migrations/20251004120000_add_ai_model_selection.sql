...
INSERT INTO products (id, name, description, price_cents, product_type, persona_id, stripe_price_id, metadata, is_active) VALUES
(uuid_generate_v4()::text, 'GPT-4o Model Access', 'Unlock OpenAI''s GPT-4o model for all your coaches', 299, 'coach', 'gpt-4o', 'price_MODEL_GPT4O', '{"model_id": "gpt-4o"}', true),
(uuid_generate_v4()::text, 'Claude 3.5 Sonnet Model Access', 'Unlock Anthropic''s Claude 3.5 Sonnet model', 299, 'coach', 'claude-3-5-sonnet', 'price_MODEL_CLAUDE_SONNET', '{"model_id": "claude-3-5-sonnet"}', true),
(uuid_generate_v4()::text, 'Claude 3 Opus Model Access', 'Unlock Anthropic''s most powerful Claude 3 Opus model', 499, 'coach', 'claude-3-opus', 'price_MODEL_CLAUDE_OPUS', '{"model_id": "claude-3-opus"}', true),
(uuid_generate_v4()::text, 'Gemini 1.5 Pro Model Access', 'Unlock Google''s Gemini 1.5 Pro with massive context', 299, 'coach', 'gemini-pro-1.5', 'price_MODEL_GEMINI', '{"model_id": "gemini-pro-1.5"}', true);